        ...
        <Pressable style={styles.sheet} onPress={event => event.stopPropagation()}>
          ...
          <View style={styles.iconGrid}>
            {systemIconChoices.map(icon => {
              ...
              const isOriginalIcon = ['work', 'study', 'exercise', 'life'].includes(icon.id);
              return <Pressable key={icon.id} onPress={() => selectSystemIcon(icon.id)} style={[styles.systemIcon, selected && styles.systemIconSelected]}>
                <Image source={getSystemIconImage(icon.id)} style={[styles.systemIconImage, isOriginalIcon && styles.originalSystemIcon]} resizeMode="contain" />
              </Pressable>;
            })}
          </View>
